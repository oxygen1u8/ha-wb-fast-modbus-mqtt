...
class FastModbusSlave:
    ...
    def __init__(
        ...
        Args:
            ...
            stop (int): Количество стоп-битов
        """
    ...
    def __str__(self):
        ...
        """
        return f"Slave ID: {hex(self.slave_id)}, Serial: {hex(self.serial_num)}, Baudrate: {self.baudrate}, Parity: {self.parity}, Stop bits: {self.stop}"
